...
fn vs_main(
    ...
    transformedPosition.z += (row - gridWidth / 2.0) * cubeSize;     // Center cubes vertically
    ...
    let st = (vec2(row, column) / vec2(gridWidth, gridWidth));
    ...
    let heightConst = 7.0;
    transformedPosition.y = baseY + vertexInput.position.y * pct * heightConst * randomHeight;
